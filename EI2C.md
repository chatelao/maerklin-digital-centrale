Dr. König´s Märklin-Digital-Page: Data communication on the I2C-Bus | by Walter Fiedler | Modelleisenbahn -
Märklin (Märklin - Maerklin) - Digital
...
Neither I can comment this documentation nor I can answer questions; so please contact Mr. Fiedler - or in case of problems with the translation Mr. Romer - directly. My part of this pulbication is limites to the WWW-adapting ; I did not change the content or it´s translation in any way. You can download the [original](i2c.zip) and it´s [translation](ei2c.zip). So I am not responsible for the content of this documentation and any results and consequences of it´s usage.*
...
* [Introduction](#einl)
* [The I2C-Bus](#i2c)
* [Identifying devices in the Märklin System](#kenn)
* [Addressing of the control modules](#adress)
* [Initialization of the control modules](#steuer)
* [Controlling locomotives in the H0-Modus](#lokho)
* [Controlling locomotives with extended Motorola format](#lokmot)
* [Controlling locomotive functions](#funkt)
* [Controlling solenoid accessories](#weich)
* [Operation with Interfaces (6050 or 6051)](#interf)
* [Differences in the communication flow between Central Unit (6020) and Control Unit (6021)](#kummu)
* [Undocumented functions for the Control Unit (6021)](#nidok)
    * [Erase previously stored data](#daten)
    * [Put all 80 addresses through a Refresh cycle](#80adr)
    * [Version test](#versi)
    * [Recall the last operating condition](#betr)
...
[*Homepage*](digital.htm) |  [![Deutsch](d-flag.gif)](i2c.htm)

![](bahn6.gif)

© 2001 by Walter Fiedler | Thüringer Straße 22 | 63329 Egelsbach |
06103/44620 | Stand: 8.5.2001
© 2002 by [Matthew Romer](MAILTO:mromer@onlink.net) | Stand: 16.3.2002

[Revisit this page](http://www.drkoenig.de/digital/i2c.htm)