...
Diese Übersicht listet die wichtigsten Komponenten des klassischen Märklin Digital-Systems auf, die über den I2C-Bus oder das Motorola-Gleisprotokoll kommunizieren.

| Typ | Name | Beschreibung | Bild |
| :--- | :--- | :--- | :--- |
| **6001** | Transformator | Transformator (52 VA) zur Stromversorgung der Control Unit oder von Boostern. | |
